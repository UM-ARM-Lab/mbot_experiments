...
def import_lcm_messages():
    ...
    # Add path for mbot_lcm_msgs from mbot_lcm_base submodule
    mbot_msgs_path = os.path.join(workspace_root, "external", "mbot_lcm_base", "mbot_msgs")
    if mbot_msgs_path not in sys.path:
        sys.path.insert(0, mbot_msgs_path)
